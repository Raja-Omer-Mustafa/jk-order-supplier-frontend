               ...
               <div id="data-step1" class="account-content" data-temp="tabdata">
                  <div class="dashboard-right">
                     <form method='POST' enctype="multipart/form-data" id="profile_form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                           <div class="col-md-6 col-lg-4 mb-lg-0 mb-md-3 mb-sm-5 mb-4">
...
</script><?php /**PATH C:\xampp\htdocs\ecart-02-live\resources\views/themes/ekartfulllayout/user/account.blade.php ENDPATH**/ ?>