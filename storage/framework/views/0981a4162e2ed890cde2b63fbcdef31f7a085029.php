                                ...
                                <form action="<?php echo e(route('cart-add')); ?>" class="addToCart" method="POST">
                                    ...
                                    <div class="row mt-4">
                                        <div class="button-container col">
                                            ...
                                            <input class="form-control qtyPicker" id="qtyPicker_<?php echo e($data['product']->id); ?>" type="number" name="qty" data-min="1" min="1" max="1" data-max="1" value="1" readonly>
                                            ...
                                            <div class="btn-group-toggle variant" data-toggle="buttons">
                                                ...
                                                <?php $__currentLoopData = getInStockVarients($data['product']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <button class="btn" data-id="<?php echo e($data['product']->id); ?>">
                                                        ...
                                                        <input type="radio" name="options" id="option<?php echo e($v->id); ?>" value="<?php echo e($v->id); ?>" data-id='<?php echo e($v->id); ?>' 
...
<?php /**PATH /home3/wrteamin/public_html/webekart/ekartfulllayout/resources/views/themes/eCart_01/product.blade.php ENDPATH**/ ?>