         ...
         <div class="col-xxl-3 col-xl-4 col-lg-5 col-md-12 col-12">
            <div class="product_left_bar">
                        ...
                        <article class="single_product">
                           ...
                           <figure>
                              ...
                              <figcaption class="product_content">
                                 <h4 class="product_name"><a href="product-details"><?php echo e($product->name); ?></a>
                                 </h4>
                                 ...
                                 <div class="addto_cart_btn inner product_data">
                                    <a class="add_to_cart addtocart_single" data-id="<?php echo e($product->product_id); ?>" data-varient="<?php echo e($product->product_variant_id); ?>" data-qty="1"  title="Add to cart">Add to Cart</a>
                                 </div>
                              </figcaption>
                           </figure>
                           <?php endif; ?>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           <a href="<?php echo e(route('sale-products', $fs->slug)); ?>" class="sale-view-all">View All</a>
                        </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </div>
                  </div>
               ...
               <div class="banner-image text-center trending-banner">
                  <img src="<?php echo e(theme('images/banner.png')); ?>" alt="banner">
               </div>
            </div>
         </div>
         <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\ecarttest4\resources\views/themes/ekartfulllayout/parts/style_1.blade.php ENDPATH**/ ?>