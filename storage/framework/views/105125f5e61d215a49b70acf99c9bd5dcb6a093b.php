                     ...
                     <div>
                        ...
                        <ul>
                           <li>
                              ...
                              <a class="<?php echo e((isset($data['discount_filter']) && is_array($data['discount_filter']) && in_array($c->slug, $data['discount_filter'])) ? 'active' : ''); ?>"><label class="custom-control-label" for="discount-10">10% Off or more</label></a>
                           </li>
                           ...
                           <li>
                              ...
                              <a class="<?php echo e((isset($data['discount_filter']) && is_array($data['discount_filter']) && in_array($c->slug, $data['discount_filter'])) ? 'active' : ''); ?>"><label class="custom-control-label" for="discount-25">25% Off or more</label></a>
                           </li>
                           ...
                           <li>
                              ...
                              <a class="<?php echo e((isset($data['discount_filter']) && is_array($data['discount_filter']) && in_array($c->slug, $data['discount_filter'])) ? 'active' : ''); ?>"><label class="custom-control-label" for="discount-35">35% Off or more</label></a>
                           </li>
                           ...
                           <li>
                              ...
                              <a class="<?php echo e((isset($data['discount_filter']) && is_array($data['discount_filter']) && in_array($c->slug, $data['discount_filter'])) ? 'active' : ''); ?>"><label class="custom-control-label" for="discount-50">50% Off or more</label></a>
                           </li>
...
</html><?php /**PATH C:\xampp\htdocs\ecarttest4\resources\views/themes/ekartfulllayout/shop.blade.php ENDPATH**/ ?>