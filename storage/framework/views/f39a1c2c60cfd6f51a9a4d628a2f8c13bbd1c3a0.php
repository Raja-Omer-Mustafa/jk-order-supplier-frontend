      ...
      <div class="row">
         ...
         <div class=" col-xl-5 col-lg-5 col-md-6 col-12">
            <div class="product_details_right productdetails2">
               ...
               <div class="price_box">
                  <span class="old_price" id="price_mrp_<?php echo e($data['product']->id); ?>"> <span class='value single_p'></span></span>
...
newDate = month + ' ' + day  + ', ' + yr;
                     ...
                     var review_add = '<div class="reviews_comment_box" id="review-'+id+'">' +
                                       ...
                                       if (parseFloat(rate) && ( Math.round(rate) ==  j)) {
                                        ...
                                        review_add += '<li><em class="fas fa-star-empty"></em></li>';
                                       }
                           ...
                           if(message == "Review updated Successfully!"){
                                       ...
                                       if (parseFloat(rate) && ( Math.round(rate) ==  j)) {
                                          ...
                                          update_rate += '<li><em class="fas fa-star-empty"></em></li>';
                                       }
...
</script><?php /**PATH C:\xampp\htdocs\ecarttest4\resources\views/themes/ekartfulllayout/product.blade.php ENDPATH**/ ?>