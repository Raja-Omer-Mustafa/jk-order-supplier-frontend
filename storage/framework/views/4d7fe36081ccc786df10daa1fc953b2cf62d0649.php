   ...
   <section class="checkout-section ptb-70">
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="dash-bg-right dash-bg-right1">
                    <h3 class="m-2 font-weight-bold text-dark"><?php echo e(__('msg.price_detail')); ?></h3>
		 ...
		 <div class="row">
            <div class="col-md-12">
                <div class="dash-bg-right dash-bg-right1">
                    <h3 class="m-2 font-weight-bold text-dark"><?php echo e(__('msg.other_details')); ?></h3>
...
</div><?php /**PATH C:\xampp\htdocs\ecarttest4\resources\views/themes/ekartfulllayout/user/order-track.blade.php ENDPATH**/ ?>