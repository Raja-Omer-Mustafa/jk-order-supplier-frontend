...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
   <div class="login_model modal-dialog " role="document">
                        ...
                        <div class="card-body loginsec modal-body">
                            ...
                            <form method="POST" action="<?php echo e(route('login')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary "> <?php echo e(__('msg.login')); ?>  </button>
                                    </div>
                            </form>
                            <p class="text-center mt-4"><?php echo e(__('msg.don')); ?>'<?php echo e(__('msg.t_have_account')); ?> <a href="#" id="btnRegister" class="btn btn-primary"><?php echo e(__('msg.sign_up')); ?></a></p>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home3/wrteamin/public_html/webekart/ekartfulllayout/resources/views/themes/eCart_01/login.blade.php ENDPATH**/ ?>