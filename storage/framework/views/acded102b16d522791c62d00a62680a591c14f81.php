   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 text-center">
            <h1><?php echo e($data['data'][0]->category_name); ?></h1>
            <ol class="breadcrumb">
                        ...
                        <div class="col-md-4 blogrespon">
                           <div class="blog-card blog-card-blog">
                              <div class="blog-card-image wow fadeInLeft">
                                 <a href="<?php echo e(route('blog-single', $bg->slug)); ?>"> <img class="img" alt="blog" src="<?php echo e($bg->image); ?>">
                                 </a>
                                 <div class="ripple-cont"></div>
                              </div>
                              <div class="blog-table wow fadeInLeft">
                                 <h6 class="blog-category blog-text-success"><em class="far fa-newspaper"></em>
                                    <?php echo e($bg->category_name); ?>

                                 </h6>
                                 <h4 class="blog-card-caption">
                                    <a href="<?php echo e(route('blog-single', $bg->slug)); ?>"><?php echo e($bg->title); ?> </a>
                                 </h4>
                                 <p class="blog-card-description"><?php if(strlen(strip_tags($bg->description)) > 180): ?> <?php echo substr(strip_tags($bg->description), 0,180) ."..."; ?> <?php else: ?> <?php echo substr(strip_tags($bg->description), 0,180); ?> <?php endif; ?></p>
                                 <div class="ftr">
...
<!-- eof details --><?php /**PATH /home3/wrteamin/public_html/webekart/ekartfulllayout/resources/views/themes/eCart_02/blogcategory.blade.php ENDPATH**/ ?>