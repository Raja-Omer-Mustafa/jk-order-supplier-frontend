                                ...
                                <?php $__currentLoopData = Cache::get('sliders'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php echo e($i == 0 ? 'active' : ''); ?>">
                                        <?php if($s->type == 'product'): ?>
                                            <a href="<?php echo e(route('product-single', $s->slug ?? '-')); ?>"><img src="<?php echo e($s->image); ?>" alt="<?php echo e($s->name); ?>" class="d-block img-fluid" ></a>
                                        <?php elseif($s->type == 'category'): ?>
                                            <a href="<?php echo e(route('category', $s->slug ?? '-')); ?>"><img src="<?php echo e($s->image); ?>" alt="<?php echo e($s->name); ?>" class="d-block img-fluid" ></a>
                                        <?php else: ?>
...
<?php /**PATH /home3/wrteamin/public_html/webekart/ekartfulllayout/resources/views/themes/eCart_01/home.blade.php ENDPATH**/ ?>