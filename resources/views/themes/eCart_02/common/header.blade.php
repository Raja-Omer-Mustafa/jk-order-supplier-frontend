...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" version="v2.1.0">
   <head>
	...
	<meta property="og:image:height" content="298"/>
      ...
      <link href="{{ asset('css/rtlcustom.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('css/intlTelInput.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('css/animate.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('fontawesome/css/all.min.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('css/switcherdemo.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('css/custom.css') }}" rel="stylesheet" type="text/css" id="theme-link"/>
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css">
      <!-- Colors -->
      <link rel="alternate stylesheet" href="{{ asset('css/colors/blue.css') }}" title="blue">
      <link rel="alternate stylesheet" href="{{ asset('css/colors/gold.css') }}" title="gold">
      ...
      <link rel="alternate stylesheet" href="{{ asset('css/colors/red.css') }}" title="red">
      ...
      <link rel="alternate stylesheet" href="{{ asset('css/colors/purplish.css') }}" title="purplish">
