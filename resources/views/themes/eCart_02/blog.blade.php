                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-3 col-12 blogrespon">
                           <div class="blog-card blog-card-blog">
                              ...
                              <div class="blog-table wow fadeInLeft">
                                 ...
                                 <p class="blog-card-description">@if(strlen(strip_tags($bg->description)) > 70) {!! substr(strip_tags($bg->description), 0,70) ."..." !!} @else {!! substr(strip_tags($bg->description), 0,70) !!} @endif</p>
                                 <div class="ftr">
