         ...
         <div class=" col-xl-5 col-lg-6 col-md-6 col-12">
            <div class="product_details_right productdetails2">
               ...
               <div class="product_desc">
                  <p>@if(strlen($data['product']->description) > 200) {!! substr($data['product']->description, 0,200) ."..." !!} @else {!! substr($data['product']->description, 0,200) !!} @endif</p>
...
<section class="product_d_info">
   <div class="container-fluid">
      <div class="row">
         ...
         {{-- featured product --}}
         @if(is_array($data['sections']['sections']) && count($data['sections']['sections']))
