        ...
        else
        {
            ...
            else
            {
                ...
                if (isset($data1))
                {
                    $totalcart = count($data1['cart']);
                    $subtotal = $data1['subtotal'];
                    $tax_amount = $data1['tax_amount']??'0';
                    $shipping = $data1['shipping']??'0';
                    $coupon_discount = $data['coupon']??'0';
                    $total = $data1['total']??'0';
